...
c.	1983: India
d.	1987: Australia
e.	1992: Pakistan#include <stdio.h>
int main (int argc, char* argv[] ) {
 /* Write a program using switch case that takes year as input and prints the name of cricket world 
cup winning country for that year, 
 SUCH THAT there is ONLY ONE print statement for each winning country irrespective of number of 
times it has won the world cup
a. 1975: West Indies
b. 1979: West Indies
c. 1983: India
d. 1987: Australia
